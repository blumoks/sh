...
int main(int argc, char **argv)
{
	...
	else if (!strcmp(argv[3],GEN_GOST_PAIR))
	{
		NuClass->GenerateGost3410KeyPairByStringAttributes(temp, argc - 4);
	}
	else if (!strcmp(argv[3],GEN_GOST_SECRET))
	{
		NuClass->GenerateGost28147KeyByStringAttributes(temp, argc - 4);
	}
